...
model_weights_path = hf_hub_download(repo_id="JANGJIWON/EmoSet118K_MonetStyle_CLIP_student", filename="CLIPEmoset118k_mone.pth")
...
# t-SNE 적용
perplexity = min(48, len(embed_labels) - 1)  # perplexity는 샘플 수보다 작아야 함
...
# t-SNE 적용
perplexity = min(48, len(test_image_embeds) - 1)  # perplexity는 샘플 수보다 작아야 함
tsne = TSNE(n_components=2, random_state=42, perplexity=perplexity)
